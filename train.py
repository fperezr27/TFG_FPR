...
def val(epoch = 0):
    ...
    with torch.no_grad():
        ...
        for idx, (rgb_ip, hsi_ip, labels) in enumerate(valloader, 0):
            ...
            print("{0:.2f}".format(acum/len(valset)*100), end = '-', flush = True)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--network_weights_path', default = './savedmodels/network.pt', help = 'Path to save Network weights')
